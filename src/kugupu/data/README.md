...
* `lammps.data.bz2`, `run9last20.dcd`: initial test system
* `H_matrix.npz`, `S_matrix.npz`: H and S fragment-basis matrix made from above system
* `matrices_traj.npz`: numpy archive of H_eq and S_eq for all 20 frames of above trajectory
